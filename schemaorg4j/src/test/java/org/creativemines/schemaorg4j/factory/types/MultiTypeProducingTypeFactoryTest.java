...
public class MultiTypeProducingTypeFactoryTest {
    ...
    public void emittedMultiTypeHasCorrectFields() {
        ...
        assertEquals(spec.fieldSpecs.get(0).type.toString(), SchemaOrg4JConstants.DOMAIN_PACKAGE + ".Audio");
        assertTrue(spec.fieldSpecs.get(0).hasModifier(Modifier.PRIVATE));
        assertEquals(spec.fieldSpecs.get(2).name, "book");
        assertEquals(spec.fieldSpecs.get(2).type.toString(), SchemaOrg4JConstants.DOMAIN_PACKAGE + ".Book");
